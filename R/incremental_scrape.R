...
main_link <- "http://www.prosportstransactions.com/football/Search/"
first_link <- "https://www.prosportstransactions.com/football/Search/SearchResults.php?Player=&Team=&BeginDate=&EndDate=&InjuriesChkBx=yes&submit=Search"
...
all_injuries <- readRDS(here::here("data", "nfl_injuries_complete_raw.rds"))
...
saveRDS(all_injuries, here::here("data", "nfl_injuries_complete_raw.rds"))
...
# write output
write(injuries_json, here::here("data", "nfl_injuries.json"))
